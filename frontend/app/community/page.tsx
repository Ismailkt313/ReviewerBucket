...
export default function CommunityPage() {
  ...
  }, [inputText, isSubmitting, scrollToBottom]);
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 min-h-0 flex flex-col">
        <div
          ref={scrollRef}
          className="flex-1 min-h-0 overflow-y-auto px-3 py-3 flex flex-col gap-1.5 scroll-smooth"
        >
          {messages.length > 0 ? (
            messages.map((msg) => (
              <div
              ...
              >
                ...
                >
                  <p className="text-[14px] leading-relaxed whitespace-pre-line break-words overflow-wrap-anywhere">
                    {msg.content}
                  </p>
        ...
        <div className="flex-shrink-0 border-t border-border bg-surface px-3 pt-2 pb-[calc(8px+env(safe-area-inset-bottom))]">
